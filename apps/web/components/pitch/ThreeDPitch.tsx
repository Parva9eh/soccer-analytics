...
import { createBumpyFieldGeometry, createGrassTexture } from "./grass-assets";
...
export function ThreeDPitch({
  ...
  const [fieldGeometry] = useState(createBumpyFieldGeometry);
  const [grassTexture] = useState(createGrassTexture);
